...
public class UnrealIRCd extends Exception implements Protocol {
    ...
    private static final Map<String, String> usermodeTxt = Map.ofEntries(
        entry("o", "o:ircop"),
        entry("d", "d:chanDeaf"),
        entry("i", "i:invisible"),
        entry("p", "p:hideChansFromWhois"),
        entry("q", "q:unkickable"),
        entry("r", "r:registered"),
        entry("s", "s:listenservernotices"),
        entry("t", "t:vhost"),
        entry("w", "w:wallops"),
        entry("x", "x:cloackedhost"),
        entry("z", "z:secure"),
        entry("B", "B:bot"),
        entry("D", "D:privdeaf"),
        entry("G", "G:filterbadwords"),
        entry("H", "H:hideircop"),
        entry("I", "I:hideidle"),
        entry("R", "R:registereddeaf"),
        entry("S", "S:service"),
        entry("T", "T:noctcp"),
        entry("W", "W:spywhois"),
        entry("Z", "Z:securedeaf")
    );

    private static final Map<String, String> chanmodeTxt = Map.ofEntries(
        entry("v", "v:voice"),
        entry("h", "h:hop"),
        entry("o", "o:op"),
        entry("a", "a:admin"),
        ...
        entry("c", "c:nocolor"),
        entry("C", "C:noctcp"),
        entry("d", "d:hasdelayedclients"),
        entry("D", "D:delayed"),
        entry("F", "F:floodprofile"),
        entry("f", "f:floodparams"),
        entry("G", "G:nobadwords"),
        entry("H", "H:history"),
        entry("i", "i:invite"),
        entry("k", "k:key"),
        entry("K", "K:noknock"),
        ...
        entry("l", "l:limit"),
        entry("m", "m:moderated"),
        entry("M", "M:regmoderated"),
        entry("N", "N:nonickchange"),
        entry("n", "n:nooutsidemsg"),
        entry("O", "O:opersonly"),
        entry("p", "p:private"),
        entry("P", "P:permanent"),
        entry("Q", "Q:nokick"),
        entry("R", "R:joinonlyreg"),
        entry("r", "r:registered"),
        entry("s", "s:secret"),
        entry("S", "S:stripcolor"),
        entry("T", "T:nonotice"),
        entry("t", "t:topiconlyops"),
        entry("V", "V:noinvite"),
        entry("z", "z:secure"),
        entry("Z", "Z:onlysecureusers")
    );
